...
Route::group(['middleware' => ['auth','admin'], 'prefix' => 'admin'], function(){
    ...
    Route::any('/transport/ajaxSubmit',[\App\Http\Controllers\TransportController::class,'ajaxSubmit'])->name('transports.ajaxSubmit');
    ...
    Route::any('/appointment/ajaxSubmit',[\App\Http\Controllers\AppointmentController::class,'ajaxSubmit'])->name('appointments.ajaxSubmit');

...
@section('content')
    ...
    <div class="modal" id="crud_Modal"  role="dialog" aria-labelledby="modal-normal" aria-hidden="true">
        <div class="modal-dialog" role="document">
            @open(['method' => 'POST', 'route' => 'appointments.ajaxSubmit','enctype'=>"multipart/form-data",'novalidate' => true])
                                ...
                                value: function () {
                                    ...
                                    new FullCalendar.Calendar(document.getElementById("js-calendar"), {
                                        ...
                                        eventDrop:function (info)
                                        {
                                            ...
                                            $.ajax({url: "{{route('appointments.ajaxSubmit')}}",data:{id:id,date:moment(new_date).format('YYYY-MM-DD')}, success: function(result){

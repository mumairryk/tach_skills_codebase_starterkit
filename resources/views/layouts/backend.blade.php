          ...
          <div class="content-side content-side-full">
            <ul class="nav-main">
              ...
              <li class="nav-main-heading">
                ...
                <li class="{{(request()->routeIs("users*") || request()->routeIs("roles*")) ? ' open' : '' }}">
                    ...
                    <ul>
                        ...
                        <li>
                            <a class="{{request()->route()->getName()=="roles" ? ' active' : '' }}" href="{{route("roles")}}">Roles</a>
                        </li>
                    </ul>
                </li>
    ...
    <footer id="page-footer">
      <div class="content py-20 font-size-sm clearfix">
        <div class="float-right">
           <i class="fa fa-heart text-pulse"></i> By <a class="font-w600" href="#" target="_blank">TechSkills</a>
        </div>
        <div class="float-left">
          <a class="font-w600" href="#" target="_blank">ZanellaDev</a> &copy; <span class="js-year-copy"></span>
        </div>
      </div>
    </footer>
    <!-- END Footer -->
